...
xhr.onload = function () {
  if (xhr.status === 200 && xhr.responseText) {
    ...
    check.open('GET', 'http://' + url + '/echo', true);
    check.timeout = 4000;
    ...
    check.onerror = function () { changeServer(); };
    check.ontimeout = function () { changeServer(); };
...
xhr.onerror = function () { changeServer(); };
xhr.ontimeout = function () { changeServer(); };
